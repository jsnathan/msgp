...
import (
	...
	"github.com/jsnathan/msgp/gen"
	"github.com/jsnathan/msgp/parse"
...
func generate(f *parse.FileSet, mode gen.Method) (*bytes.Buffer, *bytes.Buffer, error) {
	...
	myImports := []string{"github.com/jsnathan/msgp/msgp"}
	...
	if mode&gen.Test == gen.Test {
		...
		if mode&(gen.Encode|gen.Decode) != 0 {
			writeImportHeader(testbuf, "bytes", "github.com/jsnathan/msgp/msgp", "testing")
		} else {
			writeImportHeader(testbuf, "github.com/jsnathan/msgp/msgp", "testing")
		}
		testwr = testbuf
	}
...
func writePkgHeader(b *bytes.Buffer, name string) {
	...
	b.WriteString(name)
	b.WriteByte('\n')
	b.WriteString("// NOTE: THIS FILE WAS PRODUCED BY THE\n// MSGP CODE GENERATION TOOL (github.com/jsnathan/msgp)\n// DO NOT EDIT\n\n")
}
